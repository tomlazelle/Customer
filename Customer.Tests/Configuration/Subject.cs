...
using Customer.Domain.EventStores;
...
namespace Customer.Tests.Configuration
{
        ...
        where TClassUnderTest : class
    {
        ...
        public virtual void FixtureSetup(IFixture fixture)
        {
            ...
            configMgr.Get<string>("CustomerDb").Returns("http://localhost:8081");
            Register(configMgr);
        }
        ...
        public void RegisterDatabase(string databaseName = "CustomerDb")
        {
